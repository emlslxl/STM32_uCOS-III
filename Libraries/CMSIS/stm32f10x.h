/**
  ...
  *              - To use or not the peripheral闂佺顔愰幏锟� drivers in application code(i.e.
  *                code will be based on direct access to peripheral闂佺顔愰幏锟� registers
  ...
  *           - Macros to access peripheral闂佺顔愰幏锟� registers hardware
  *
  ******************************************************************************
  * @attention
  *
